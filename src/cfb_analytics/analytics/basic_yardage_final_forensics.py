...
def concise(r):
 ...
 '',"Recovered INT attempts are denominator-only for Basic Yardage v1: their source yardage is interception-return movement, not validated offensive passing yardage. Diagnostic only until propagation is locked."
 ];return '\n'.join(lines)

...
const metrics = [
  ...
  ["Market win chance", "A historical calibration from a sourced point spread. It is market context, not a SOAR game prediction."],
];

export default function Methodology() {
  return <div className="methodology-page">
    <section className="page-banner"><div className="wrap page-banner-inner"><div><span className="kicker">HOW SOAR WORKS</span><h1>READ THE EVIDENCE</h1><p>Advanced football analysis in fan language—with every number labeled by what it knows and what it does not.</p></div><div className="banner-mark">4</div></div><div className="wrap summary-rail"><span><small>CURRENT TEAM DATA</small><b>2026 PRESEASON</b></span><span><small>PERFORMANCE BASELINE</small><b>2025 ACTUAL</b></span><span><small>MISSING DATA</small><b>NEVER INVENTED</b></span></div></section>
    <div className="wrap methodology-stack">
      ...
      <section className="methodology-split"><div><span className="kicker maize">CURRENT DATA STATUS</span><h2>What SOAR knows today.</h2></div><div><p><b>2026 roster, staff, schedule and roles:</b> preseason evidence.</p><p><b>Michigan and Utah team performance:</b> completed 2025 actuals.</p><p><b>Recruiting:</b> consensus benchmarks, not college proof.</p><p><b>Markets:</b> sourced prices and historical spread calibration.</p><p><b>2026 in-season analytics:</b> begin only after observed games are published.</p></div></section>
      <section className="methodology-split light"><div><span className="kicker navy">TRUST CONTRACT</span><h2>What SOAR will not do.</h2></div><div><p>SOAR does not invent rankings, grades, player roles, probabilities, or historical comparisons when an artifact is missing.</p><p>Utah's 2025 performance describes recent staff context; it does not guarantee Michigan will reproduce Utah's tendencies or results.</p><p>Public language may simplify a calculation, but it does not change its denominator, direction, or underlying definition.</p></div></section>
    </div>
  </div>;
}
